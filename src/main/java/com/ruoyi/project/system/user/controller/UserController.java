...
import com.ruoyi.project.Utils.ExecutorServiceUtils;
...
//        }
     ...
     * @return
     */
    @GetMapping("/selectJuniorUserByUser/{deptId}")
    @ResponseBody
    public Object selectJuniorUserByUser(@PathVariable("deptId") Long deptId) {
        Long departId = deptId == 0 ? getSysUser().getDeptId() : deptId;
        User user = new User();
