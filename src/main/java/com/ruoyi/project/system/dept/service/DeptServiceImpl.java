...
public class DeptServiceImpl implements IDeptService
{
    ...
    /**
     * 根据deptID查询本部门及其所有子部门
     * @param deptId
     * @return
     */
    public List<Dept> selectDeptListByDeptId(Long deptId) {
        return deptMapper.selectDeptListByDeptId(deptId);
    }

    @Override
    public List<Dept> selectYw() {
        return deptMapper.selectYw();
    }

    @Override
    public List<Dept> getSubAllList(Dept dept) {
        return deptMapper.getSubAllList(dept);
    }
}
